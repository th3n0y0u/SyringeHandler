local function mainclass()
	...
	local licensesmodule = game:GetService("ServerScriptService"):WaitForChild("LicenseTable")
	local licenses = require(licensesmodule)
	...
	local function checklicense()
		if equipped == false then
			...
			if allowed == false then
				...
				local clone = script.Parent.LicenseGiver:Clone()
